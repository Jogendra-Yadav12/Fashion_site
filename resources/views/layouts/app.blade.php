...
<head>
    ...
    <link rel="icon" href="{{asset('public/assets/images/favicon/7.png')}}" type="image/x-icon">
    ...
    <!-- bootstrap css -->
    <link id="rtl-link" rel="stylesheet" type="text/css" href="{{asset('public/assets/css/vendors/bootstrap.css')}}">
    ...
    <!-- Iconly css -->
    <link rel="stylesheet" type="text/css" href="{{asset('public/assets/css/bulk-style.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('public/assets/css/vendors/animate.css')}}">

    <!-- Template css -->
    <link id="color-link" rel="stylesheet" type="text/css" href="{{asset('public/assets/css/style.css')}}">
</head>
...
<body class="theme-color-5">
        ...
        <div class="container-fluid-lg">
                ...
                <div class="row g-md-4 gy-sm-5">
                    ...
                    <div class="col-xxl-4 col-xl-4 col-sm-6">
                        ...
                        <ul class="footer-list footer-contact footer-list-light">
                            <li>
                                <a href="{{url('/aboutus')}}" class="light-text">About Us</a>
                            </li>
                            <li>
                                <a href="{{url('/contactus')}}" class="light-text">Contact Us</a>
                            </li>
                            <li>
            ...
            <div class="sub-footer sub-footer-lite section-b-space section-t-space">
                ...
                <ul class="payment-box">
                    <li>
                        <img src="{{asset('public/assets/images/icon/paymant/visa.png')}}" class="blur-up lazyload"
                            alt="">
                    </li>
                    <li>
                        <img src="{{asset('public/assets/images/icon/paymant/discover.png')}}" alt=""
                            class="blur-up lazyload">
                    </li>
                    <li>
                        <img src="{{asset('public/assets/images/icon/paymant/american.png')}}" alt=""
                            class="blur-up lazyload">
                    </li>
                    <li>
                        <img src="{{asset('public/assets/images/icon/paymant/master-card.png')}}" alt=""
                            class="blur-up lazyload">
                    </li>
                    <li>
                        <img src="{{asset('public/assets/images/icon/paymant/giro-pay.png')}}" alt=""
                            class="blur-up lazyload">
                    </li>
                </ul>
            </div>
                    ...
                    <div class="deal-offer-box">
                        <ul class="deal-offer-list">
                            <li class="list-1">
                                <div class="deal-offer-contain">
                                    <a href="#" class="deal-image">
                                        <img src="{{asset('public/assets/images/vegetable/product/10.png')}}"
                            ...
                            <li class="list-2">
                                <div class="deal-offer-contain">
                                    <a href="#" class="deal-image">
                                        <img src="{{asset('public/assets/images/vegetable/product/11.png')}}"
                                            class="blur-up lazyload" alt="">
                                    </a>
                            ...
                            <li class="list-3">
                                <div class="deal-offer-contain">
                                    <a href="#" class="deal-image">
                                        <img src="{{asset('public/assets/images/vegetable/product/12.png')}}"
                                            class="blur-up lazyload" alt="">
                                    </a>
                            ...
                            <li class="list-1">
                                <div class="deal-offer-contain">
                                    <a href="#" class="deal-image">
                                        <img src="{{asset('public/assets/images/vegetable/product/13.png')}}"
                                            class="blur-up lazyload" alt="">
                                    </a>
    ...
    <script src="{{asset('public/assets/js/bootstrap/bootstrap-notify.min.js')}}"></script>
    <script src="{{asset('public/assets/js/bootstrap/popper.min.js')}}"></script>

    <!-- feather icon js-->
    <script src="{{asset('public/assets/js/feather/feather.min.js')}}"></script>
    <script src="{{asset('public/assets/js/feather/feather-icon.js')}}"></script>
    ...
    <script src="{{asset('public/assets/js/slick/slick-animation.min.js')}}"></script>
    <script src="{{asset('public/assets/js/slick/custom_slick.js')}}"></script>

    <!-- Auto Height Js -->
    <script src="{{asset('public/assets/js/auto-height.js')}}"></script>

    <!-- WOW js -->
    <script src="{{asset('public/assets/js/wow.min.js')}}"></script>
    <script src="{{asset('public/assets/js/custom-wow.js')}}"></script>

    <!-- script js -->
    <script src="{{asset('public/assets/js/script.js')}}"></script>

    <!-- theme setting js -->
    <script src="{{asset('public/assets/js/theme-setting.js')}}"></script>
</body>
