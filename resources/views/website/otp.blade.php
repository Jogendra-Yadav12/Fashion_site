            ...
            <div class="row">
                <div class="col-xxl-6 col-xl-5 col-lg-6 d-lg-block d-none ms-auto">
                    <div class="image-contain">
                        <img src="{{asset('public/assets/images/inner-page/otp.png')}}" class="img-fluid" alt="">
                    </div>
                </div>
                    ...
                    @csrf
                        <div class="log-in-box">
                            <div class="log-in-title">
                                ...
                                <h5 class="text-content">A code has been sent to <span></span></h5>
                            </div>
                            
                            <div id="otp" class="inputs d-flex flex-row justify-content-center">
                                <input class="text-center form-control rounded" type="text" name="otp" placeholder="0">
                            </div>
