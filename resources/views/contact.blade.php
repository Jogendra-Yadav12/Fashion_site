            ...
            <div class="container">
                <div class="row pb--80"> 
                    <div class="col-md-7 mb-sm--30">
                        ...
                        <form class="form" action="https://htmldemo.net/zakas/zakas/mail.php" id="contact-form">
                    ...
                    <div class="col-md-5 pl--50 pl-sm--30">
                        ...
                        <div class="contact-info-widget mb--45">
                            <div class="contact-info">
                                ...
                                <p>You address goes here <br> 221B Baker Street</p>
                            </div>
                        </div>
                        ...
                        <ul class="social social-sharing">
                            <li class="social__item">
                                <a href="https://twitter.com/" target="_blank" rel="noopener" class="social__link twitter">
                            ...
                            <li class="social__item">
                                <a href="https://instagram.com/" target="_blank" rel="noopener" class="social__link instagram">
