			...
			<div class="container-fluid">
				<div class="row">
					...
					<div class="col-xl-3 col-md-3 col-6">
						<div class="card  blog-card">
							<div class="card-body text-center">
								<!--<img src="{{asset('public/images/books.png')}}" alt=""> -->
					...
					<div class="col-xl-3 col-md-3 col-6">
						<div class="card  blog-card">
							<div class="card-body text-center">
								<!--<img src="{{asset('public/images/news.png')}}" alt=""> -->
								<h4>Product</h4>
								<h6>{{$product}}</h6>
							</div>
						</div>
					...
					<div class="col-xl-3 col-md-3 col-6">
						<div class="card blog-card ">
							<div class="card-body text-center">
								<!--<img src="{{asset('public/images/heart.png')}}" alt=""> -->
								<h4>Order</h4>
								<h6>{{$order}}</h6>
							</div>
						</div>
					...
					<div class="col-xl-3 col-md-3 col-6">
						<div class="card  blog-card">
							<div class="card-body text-center">
								<!--<img src="{{asset('public/images/file.png')}}" alt=""> -->
								<h4>Customer</h4>
								<h6>{{$user}}</h6>
							</div>
						</div>
