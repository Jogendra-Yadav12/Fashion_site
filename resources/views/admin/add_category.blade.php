                                                        ...
                                                        @foreach ($data as $d)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a href="{{ route('deletecategory', ['id' => $d->id]) }}"
                    ...
                    <div class="col-xl-12 col-lg-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="basic-form">
                                    <form method="POST" action="{{ route('uploadsubcategory') }}"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <div class="mb-3 col-md-6">
                                                    ...
                                                    @else
                                                        @foreach ($Subdata as $sub)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="{{ route('deletesubcategory', ['id' => $sub->id]) }}"
                                                                        class="delete-confirm">
                                                                        <i class="fa fa-trash text-danger fa-2x"></i>
                                                                    </a>
                                                                </td>
                                            ...
                                            @foreach ($colors as $col)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ route('deletecolor', ['id' => $col->id]) }}"
                                                            class="delete-confirm">
                                                            <i class="fa fa-trash text-danger fa-2x"></i>
                                                        </a>
                                                    </td>
                                        ...
                                        @foreach ($sizes as $size)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('deletesize', ['id' => $size->id]) }}"
                                                        class="delete-confirm">
                                                        <i class="fa fa-trash text-danger fa-2x"></i>
                                                    </a>
                                                </td>
