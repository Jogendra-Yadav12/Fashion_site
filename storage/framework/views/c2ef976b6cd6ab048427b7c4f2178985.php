            ...
            <div class="row g-sm-4 g-3 section-b-space">
                <div class="col-xxl-12 ratio_110">
                    <div class="slider-6 img-slider">
                        <?php $__currentLoopData = $women; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div>
    ...
    <!-- Deal Section End --><?php /**PATH E:\xampp\htdocs\fastkart\resources\views/website/bottomdeal.blade.php ENDPATH**/ ?>