			...
			<div class="container-fluid">
				<div class="row">
					...
					<div class="col-xl-3 col-md-3 col-6">
						<div class="card  blog-card">
							<div class="card-body text-center">
								<!--<img src="<?php echo e(asset('public/images/books.png')); ?>" alt=""> -->
					...
					<div class="col-xl-3 col-md-3 col-6">
						<div class="card  blog-card">
							<div class="card-body text-center">
								<!--<img src="<?php echo e(asset('public/images/news.png')); ?>" alt=""> -->
								<h4>Product</h4>
								<h6><?php echo e($product); ?></h6>
							</div>
						</div>
					</div>
					<div class="col-xl-3 col-md-3 col-6">
						<div class="card blog-card ">
							<div class="card-body text-center">
								<!--<img src="<?php echo e(asset('public/images/heart.png')); ?>" alt=""> -->
								<h4>Order</h4>
								<h6><?php echo e($order); ?></h6>
							</div>
						</div>
					</div>
					<div class="col-xl-3 col-md-3 col-6">
						<div class="card  blog-card">
							<div class="card-body text-center">
								<!--<img src="<?php echo e(asset('public/images/file.png')); ?>" alt=""> -->
								<h4>Customer</h4>
...
<?php endif; ?><?php /**PATH E:\xampp\htdocs\fastkart\resources\views/admin/profile.blade.php ENDPATH**/ ?>