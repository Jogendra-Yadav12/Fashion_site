                            ...
                            <div class="main-nav navbar navbar-expand-xl navbar-light navbar-sticky">
                                <div class="offcanvas offcanvas-collapse order-xl-2" id="primaryMenu">
                                    ...
                                    <div class="offcanvas-body">
                                        <ul class="navbar-nav">
                                            <li class="nav-item">
                                                <a class="nav-link ps-xl-2 ps-0" href="<?php echo e(url('/')); ?>">Home</a>
                                            </li>
                            ...
                            <ul class="right-side-menu">
                                ...
                                <li class="right-side">
                                    <div class="onhover-dropdown header-badge">
                                        ...
                                        <a href="<?php echo e(url('/usercart')); ?>"
                                            class="btn p-0 position-relative header-wishlist">
                                            <i data-feather="shopping-cart"></i>
                                            <span
                                                class="position-absolute top-0 start-100 translate-middle badge"><?php echo e($cart); ?>
                                ...
                                <li class="right-side onhover-dropdown">
                                    <div class="delivery-login-box">
                                        <div class="delivery-icon">
                                            <?php if(session()->get('name')): ?>
                                            <a href="<?php echo e(url('userprofile')); ?>"><i data-feather="user"></i></a>
                                        </div>
                                    </div>
                                    <?php else: ?>
                                    ...
                                    <div class="onhover-div onhover-div-login">
                                        <ul class="user-box-name">
                                            <li class="product-box-contain">
                                                <i></i>
                                                <a href="<?php echo e(url('logi')); ?>">Log In</a>
                                            </li>
...
<div class="mobile-menu d-md-none d-block mobile-cart">
    <ul>
        ...
        <li>
            <a href="<?php echo e(url('userprofile')); ?>" class="search-box">
...
<!-- mobile fix menu end --><?php /**PATH E:\xampp\htdocs\fastkart\resources\views/website/nav.blade.php ENDPATH**/ ?>