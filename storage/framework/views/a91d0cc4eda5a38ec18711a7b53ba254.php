...
img:hover{
    ...
    <div class="content-body">
        ...
        <div class="container-fluid">
         ...
         <!-- <a class="btn btn-primary btn-sm"  href="<?php echo e(url('/add_subcategory')); ?>" role="button" aria-controls="offcanvasExample">+ Add Sub Category</a>
          <a class="btn btn-primary btn-sm"  href="<?php echo e(url('/add_color')); ?>" role="button" aria-controls="offcanvasExample">+ Add Color</a>
          <a class="btn btn-primary btn-sm" data-bs-toggle="offcanvas" href="<?php echo e(url('/add_size')); ?>" role="button" aria-controls="offcanvasExample">+ Add Size</a>
         -->
            ...
            <div class="card-body">
              ...
              <?php endif; ?>
                <div class="basic-form">
                    <form method="POST" action="<?php echo e(route('uploadproduct')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <select class="form-select" name="category">
                                <?php $__currentLoopData = $data1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?>
                          ...
                          <select class="form-select" name="subcategory">
                              <?php $__currentLoopData = $data3; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <option value="<?php echo e($subcategory->subcategory); ?>"><?php echo e($subcategory->subcategory); ?></option>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          </select>
                      </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <select class="form-select" name="color[]" multiple>
                            <?php $__currentLoopData = $data4; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?>
                      ...
                      <select class="form-select" name="size[]" multiple>
                          <?php $__currentLoopData = $data5; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <table id="example" class="display table" style="min-width: 845px">
              ...
              <?php else: ?>
                ...
                <tr>
                  ...
                  <td><?php echo e($d->subcategory); ?></td>
                  <td>
                    <?php
                ...
                <td>
                  ...
                  <td class="div-img">
                    <?php $__currentLoopData = json_decode($d->image); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <img src="<?php echo e(asset('public/images/' . $image)); ?>" alt="Image" style="height:70px!important;width:70px!important">
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </td>
													<td>
														<a href="<?php echo e(route('updateproduct', ['id' => $d->id])); ?>">
															<i class="fa fa-edit text-success fa-2x"></i>
														</a>
														<!--<a href="<?php echo e(route('deleteproduct', ['id' => $d->id])); ?>" class="delete-confirm">
	...
	<div class="modal-dialog modal-dialog-center">
	  <div class="modal-content">
		...
		<div class="modal-body">
			  ...
			  <div class="row">
          <form method="POST" action="<?php echo e(route('uploadcategory')); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="row">
                <div class="mb-3 col-md-12">
...
<div class="modal fade" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModalLabel2" aria-hidden="true">
	<div class="modal-dialog modal-dialog-center">
	  <div class="modal-content">
		...
		<div class="modal-body">
			  <div class="row">
          <form method="POST" action="<?php echo e(route('uploadsubcategory')); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="row">
                <div class="mb-3 col-md-12">
...
<?php endif; ?><?php /**PATH E:\xampp\htdocs\fastkart\resources\views/admin/add_product.blade.php ENDPATH**/ ?>