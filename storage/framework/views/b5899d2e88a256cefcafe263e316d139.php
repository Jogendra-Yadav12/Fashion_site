...
<head>
    ...
    <link rel="icon" type="image/png" href="<?php echo e(asset('public/Auth/images/icons/favicon.ico')); ?>" />

    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/Auth/vendor/bootstrap/css/bootstrap.min.css')); ?>">

    <link rel="stylesheet" type="text/css"
        href="<?php echo e(asset('public/Auth/fonts/font-awesome-4.7.0/css/font-awesome.min.css')); ?>">

    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/Auth/vendor/animate/animate.css')); ?>">

    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/Auth/vendor/css-hamburgers/hamburgers.min.css')); ?>">

    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/Auth/vendor/select2/select2.min.css')); ?>">

    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/Auth/css/util.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/Auth/css/main.css')); ?>">
...
<body>
        ...
        <?php endif; ?>
            <div class="wrap-login100">
                <div class="login100-pic js-tilt" data-tilt>
                    <img src="<?php echo e(asset('public/Auth/images/img-01.png')); ?>" alt="IMG">
                </div>
                <form class="login100-form validate-form" method="post" action="<?php echo e(url('admin-login')); ?>">
                    <?php echo csrf_field(); ?>
    ...
    <script src="<?php echo e(asset('public/Auth/vendor/jquery/jquery-3.2.1.min.js')); ?>"></script>

    <script src="<?php echo e(asset('public/Auth/vendor/bootstrap/js/popper.js')); ?>"></script>
    <script src="<?php echo e(asset('public/Auth/vendor/bootstrap/js/bootstrap.min.js')); ?>"></script>

    <script src="<?php echo e(asset('public/Auth/vendor/select2/select2.min.js')); ?>"></script>
    <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/js/bootstrap.min.js"></script>
    <script src="<?php echo e(asset('public/Auth/vendor/tilt/tilt.jquery.min.js')); ?>"></script>
    <script>
        $('.js-tilt').tilt({
            scale: 1.1
        })
    ...
    <script src="<?php echo e(asset('public/Auth/js/main.js')); ?>"></script>
...
<?php /**PATH E:\xampp\htdocs\fastkart\resources\views/auth/login.blade.php ENDPATH**/ ?>