 ...
 <section class="home-section-2 home-section-bg pt-0 overflow-hidden">
                    ...
                    <div class="slider-animate">
                        <div>
                            <div class="home-contain rounded-0 p-0">
                                <img src="<?php echo e(asset('public/assets/images/fashion/home-banner/1.jpg')); ?>"
                                ...
                                <div class="home-detail home-big-space p-center-left home-overlay position-relative">
                                    <div class="container-fluid-lg">
                                        <div>
                                            ...
                                            <a href="<?php echo e(url('shop')); ?>" style="width:30%"
                                                class="btn theme-bg-color btn-md text-white fw-bold mt-md-4 mt-2 mend-auto">Shop
                                                Now <i class="bi bi-arrow-right icon"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <!-- Home Section End --><?php /**PATH E:\xampp\htdocs\fastkart\resources\views/website/topbanner.blade.php ENDPATH**/ ?>